...
const Footer = () => {
  return (
    <footer className="border border-[#B8E0D2]">
      <div className="flex flex-col md:flex-row md:justify-around items-center justify-end text-center gap-6 px-4 md:px-28 text-base-content">
      ...
      <div className="px-10 py-4 border-t border-[#B8E0D2] bg-[#B8E0D2]">
        <nav className="flex flex-col justify-center items-center ">
          <p className="text-center">
            Copyright © 2024 - All right reserved by Eventful Soirees
          </p>
        </nav>
      </div>
    </footer>
