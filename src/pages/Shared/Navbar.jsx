    ...
    return (
        <div className=" bg-[#B8E0D2]">
           ...
           <div className="navbar-start">
                ...
                <li><NavLink className={({isActive})=>isActive? 'px-3 py-2 rounded-md font-semibold underline':'px-3 py-2 rounded-md'} to="/">Home</NavLink></li>
                <li><NavLink className={({isActive})=>isActive? 'px-3 py-2 rounded-md font-semibold underline':'px-3 py-2 rounded-md'} to="/services">Services</NavLink></li>
                    <li>
                    <a>Dashboard</a>
                    <ul className="p-2">
            ...
            <div className="navbar-center hidden lg:flex">
                ...
                <li><NavLink className={({isActive})=>isActive? 'px-3 py-2 rounded-md font-semibold underline mr-2':'px-3 py-2 rounded-md mr-2 font-medium'} to="/">Home</NavLink></li>
