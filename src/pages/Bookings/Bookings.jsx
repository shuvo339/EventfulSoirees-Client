  ...
  <div className="my-8">
    <Helmet>
          ...
          <div className="h-20 bg-blue-100 flex justify-center items-center">
            <h2 className="text-3xl font-semibold">Purchase Now</h2>
            </div>

    <form onSubmit={handleBooking} className="border border-blue-100 rounded-lg p-4 mt-8">
      <div className="grid md:grid-cols-2 gap-8 p-4">
        <div className="w-full">
          ...
          <input name="serviceId" defaultValue={_id} disabled type="text"
            className="w-full px-4 py-2 mt-2 text-gray-600 bg-blue-100 border border-gray-200 rounded-md  focus:border-emerald-400 focus:ring-emerald-300 focus:ring-opacity-40  focus:outline-none focus:ring"
          />
        </div>
        <div className="w-full">
      ...
      <button className="btn bg-[#9ACCC9] md:w-1/2">Purchase</button>
      </div>
    </form>
  </div>
  );
